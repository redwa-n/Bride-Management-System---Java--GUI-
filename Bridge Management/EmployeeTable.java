...
class EmployeeTable extends JFrame implements ActionListener{//,ChangeListener{
	private JTable table;
	private DefaultTableModel model;
	private JScrollPane sc;
	private Container c;
	private JLabel titleLabel,fnLabel,lnLabel,salaryLabel,idLabel,jS;
	JSlider slider;
	private JTextField fntf,lntf,sltf,itf;
	private JButton addButton, updateButton,deleteBUtton,clearButton,exitButton,backButton;
	...
	public void initComponents(){
		...
		c.setLayout(null);
		c.setBackground(new Color(198, 65, 83));
		...
		//slider=new JSlider(22,38,30);
		//c.add(slider);
		/* 
		jS=new JLabel();
		c=new JPanel();
        slider.setPreferredSize(new DimensionUIResource(40,30));
		slider.setBounds(400,40 , 40, 30);
 ...
 public void actionPerformed(ActionEvent a)
    {
		...
		{
			Employee3 c6 = new Employee3();
			c6.setVisible(true);
			this.setVisible(false);
		}
		/*else if(e2.getSource()==c2NxtBtn)
		{
			Employee3 c3 = new Employee3();
			c3.setVisible(true);
			this.setVisible(false);
		}*/
